Children under the age of 8 must have adult present while using sound backpack, do not expose to water, do not directly expose body to bass shaker, avoid dropping backpack, anyone who suffers from any heart issues must consult with doctor prior to usage, if you suffer from any chest or spine injuries/conditions, consult doctor before use, if you have any respiratory conditions, consult doctor before use, users with motion sickness are not advised to wear the backpack, if you become dizzy, immediately sit down, remove the backpack, and request for help if needed.
